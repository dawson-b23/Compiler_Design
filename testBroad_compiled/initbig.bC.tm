SEMANTIC WARNING(31): Variable 'x' may be uninitialized when used here.
SEMANTIC WARNING(46): Variable 'y' may be uninitialized when used here.
* bC compiler version bC-Su23
* File compiled:  initbig.bC
* 
* ** ** ** ** ** ** ** ** ** ** ** **
* FUNCTION input
