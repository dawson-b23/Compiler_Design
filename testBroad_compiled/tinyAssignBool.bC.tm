SEMANTIC WARNING(34): Variable 'zx' may be uninitialized when used here.
SEMANTIC WARNING(34): Variable 'zy' may be uninitialized when used here.
* bC compiler version bC-Su23
* File compiled:  tinyAssignBool.bC
* 
* ** ** ** ** ** ** ** ** ** ** ** **
* FUNCTION input
...
* EXPRESSION
* CALL outputb
 46:     ST  1,-28(1)	Store fp in ghost frame for outputb
* TOFF dec: -29
* TOFF dec: -30
* Param 1
...
* EXPRESSION
* CALL outputb
 60:     ST  1,-28(1)	Store fp in ghost frame for outputb
* TOFF dec: -29
* TOFF dec: -30
* Param 1
...
* EXPRESSION
* CALL outputb
 74:     ST  1,-28(1)	Store fp in ghost frame for outputb
* TOFF dec: -29
* TOFF dec: -30
* Param 1
...
* EXPRESSION
* CALL outputb
 88:     ST  1,-28(1)	Store fp in ghost frame for outputb
* TOFF dec: -29
* TOFF dec: -30
* Param 1
...
* EXPRESSION
* CALL outputb
107:     ST  1,-28(1)	Store fp in ghost frame for outputb
* TOFF dec: -29
* TOFF dec: -30
* Param 1
...
* EXPRESSION
* CALL outputb
121:     ST  1,-28(1)	Store fp in ghost frame for outputb
* TOFF dec: -29
* TOFF dec: -30
* Param 1
...
* TOFF set: -28
* EXPRESSION
133:    LDC  3,1(6)	Load Boolean constant 
134:     ST  3,-16(1)	Store variable sx
* EXPRESSION
* CALL outputb
135:     ST  1,-28(1)	Store fp in ghost frame for outputb
* TOFF dec: -29
* TOFF dec: -30
* Param 1
...
* EXPRESSION
* CALL outputb
149:     ST  1,-28(1)	Store fp in ghost frame for outputb
* TOFF dec: -29
* TOFF dec: -30
* Param 1
