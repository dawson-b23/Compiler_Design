SEMANTIC WARNING(2): The variable 'q' seems not to be used.
SEMANTIC WARNING(7): The variable 'q' seems not to be used.
SEMANTIC WARNING(12): The variable 'q' seems not to be used.
* bC compiler version bC-Su23
* File compiled:  examplearray3.bC
* 
* ** ** ** ** ** ** ** ** ** ** ** **
* FUNCTION input
