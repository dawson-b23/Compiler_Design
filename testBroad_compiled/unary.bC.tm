SEMANTIC WARNING(35): Variable 'a' may be uninitialized when used here.
SEMANTIC WARNING(36): Variable 'b' may be uninitialized when used here.
* bC compiler version bC-Su23
* File compiled:  unary.bC
* 
* ** ** ** ** ** ** ** ** ** ** ** **
* FUNCTION input
