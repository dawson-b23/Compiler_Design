...
parmId         :  ID          { $$ = newExpNode(ExpKind::IdK, $1); }
               |  ID '[' ']'  { $$ = newExpNode(ExpKind::IdK, $1);}
               ;
...
mutable        :  ID             { $$ = newExpNode(ExpKind::IdK, $1); }
               |  ID '[' exp ']' { $$ = newExpNode(ExpKind::IdK, $1, $3);}
               ;
...
call           :  ID '(' args ')'   { $$ = newExpNode(ExpKind::IdK, $1, $3);}
               ;
