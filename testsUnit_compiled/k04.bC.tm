SEMANTIC WARNING(5): The variable 'y' seems not to be used.
SEMANTIC WARNING(3): The variable 'i' seems not to be used.
SEMANTIC WARNING(3): The variable 'j' seems not to be used.
SEMANTIC WARNING(3): The variable 'k' seems not to be used.
* bC compiler version bC-Su23
* File compiled:  k04.bC
* 
* ** ** ** ** ** ** ** ** ** ** ** **
* FUNCTION input
