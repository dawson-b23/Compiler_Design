SEMANTIC WARNING(14): Variable 'b' may be uninitialized when used here.
SEMANTIC WARNING(16): Variable 'd' may be uninitialized when used here.
SEMANTIC WARNING(11): The variable 'c' seems not to be used.
SEMANTIC WARNING(12): The variable 'cs' seems not to be used.
SEMANTIC WARNING(26): Variable 'd' may be uninitialized when used here.
SEMANTIC WARNING(21): The variable 'c' seems not to be used.
SEMANTIC WARNING(22): The variable 'cs' seems not to be used.
SEMANTIC WARNING(8): The variable 'a' seems not to be used.
SEMANTIC WARNING(9): The variable 'as' seems not to be used.
SEMANTIC WARNING(3): The variable 'g' seems not to be used.
SEMANTIC WARNING(31): The variable 'i' seems not to be used.
* bC compiler version bC-Su23
* File compiled:  s05.bC
* 
* ** ** ** ** ** ** ** ** ** ** ** **
* FUNCTION input
