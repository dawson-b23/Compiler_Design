...
constant       :  NUMCONST    { $$ = newExpNode(ExpKind::ConstantK, $1); $$->type = ExpType::Integer; }
               ...
               |  STRINGCONST { $$ = newExpNode(ExpKind::ConstantK, $1); $$->type = ExpType::Char; $$->isArray = true; $$->size = strlen($1->tokenstr) + 1 ;}  // changed to size + 1
...
int main(int argc, char **argv) {
   ...
   syntaxTree = semanticAnalysis(syntaxTree, true, true, symtab, goffset);
